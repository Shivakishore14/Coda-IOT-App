...
<%@page import="com.sk.coda.iot.myutil.*"%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <c:forEach items="${companyList}" var="company">
                                	<li class="list-elt">
                                    	<a href="#" secret=${company.secret} cid=${company.cid } onClick="companyClicked(this)">${company.name}</a>
                                	</li>
                                </c:forEach>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><c:out value="${name}" /> <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="/codaiot/login?option=logout">Log out</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
